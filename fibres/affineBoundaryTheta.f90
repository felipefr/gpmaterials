...
!     ------------------------------------------------------------------
Subroutine affineBoundaryTheta(AE, BE, MaxLRows, XLL, NDim, iDofT, NodELT, Sol0, &
...
!     ------------------------------------------------------------------
	...
	pen = (1.0d0 - theta)*(1.0d0 - theta)/(eps + theta*(1.0d0 - eps))
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Subroutine affineBoundaryThetaS(Coupling,CommonPar,iDofT,Ndim,MaxLRows,iAdd)
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
